    ...
    <body>
        ...
        <div id="top">
            <div class="wrap clear">
                ...
                <div class="topRight fr clear">
                    <ul class="leftNav fl">
                        <li>
                            <a class="padl10" title="查看购物车" name="购物车" href="shopCar.html">购物车</a>
                            <span class="sep">|</span>
                        </li>
                        <li class="myOrder">
                            <a title="查看我的订单" name="我的订单" href="orderDetail.html" target="_blank">我的订单</a>
                            <i class="myLibIcon"></i>
                        ...
                        <ul class="rightNav fr">
                            ...
                            <li><a title="退出系统" name="退出" href="exitServlet">退出</a></li>
                        </ul>
                </div>
            </div>
        </div>
            ...
            <div class="search fr">
                <form method="post" action="product.html">
                    ...
                    <div class="search_bottom">
                        <span>搜索条件：</span>
                        <input type="radio" name="radio" value="">图书价格
                        <input type="radio" name="radio" value="">图书名称
                        <input type="radio" name="radio" value="">图书版本
                    </div>
        ...
        <div id="navbar">
            <div class="wrap clear">
                ...
                <ul>
                    ...
                    <li class="today">
                        <a title="浏览商品列表" href="lookCosmetic.html">浏览图书
                    ...
                    <li class="lookbook">
                        <a title="查询图书" href="searchCosmetic.html">查询图书</a>
                    </li>
                ...
                <ul>
                    ...
                    <li class="list noBot">
                        <div class="list_cont">
                            ...
                            <p>
                                <a class="red_f" href="" target="_blank">科普读物</a><a class="red_f" href="" target="_blank">计算机</a>
                ...
                <div class="tWrapper" style="overflow: hidden; ">
                    <ul>
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="昙华林书屋" target="_blank"><img width="700" height="456" src="../image/bg10.jpg" alt="昙华林书屋"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="邂逅浪漫与温情" target="_blank">昙华林书屋<br>
                                        邂逅浪漫与温情</a></h3>
                                    <p class="hdx">百年的古朴街道，梦与爱的交织。在这里，随处可见的路边小屋，走进书的世界，品尝时尚文化，回忆古典风情，还能意外的邂逅美好爱情。昙华林欢迎您！</p>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="OS7挑战极简主义" target="_blank"><img width="700" height="456" src="../image/bg1.jpg" alt="OS7挑战极简主义"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="OS7挑战极简主义" target="_blank">OS7挑战极简主义<br>
                                        扁平化风格来袭</a></h3>
                        ...
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="摩登升级新宠" target="_blank"><img width="700" height="456" src="../image/bg2.jpg" alt="摩登升级新宠"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="摩登升级新宠" target="_blank">摩登升级新宠<br>
                                        帅气阔腿裤盛夏随性穿</a></h3>
                        ...
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="萧蔷素食养生" target="_blank"><img width="700" height="456" src="../image/bg3.jpg" alt="萧蔷素食养生"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="萧蔷素食养生" target="_blank">萧蔷素食养生<br>
                                        健康素食有6大黄金原则</a></h3>
                        ...
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="生化病毒入侵" target="_blank"><img width="700" height="456" src="../image/bg4.jpg" alt="生化病毒入侵"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="生化病毒入侵" target="_blank">生化病毒入侵<br>
                                        僵尸类手机游戏专辑</a></h3>
                        ...
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="多彩腕表推荐" target="_blank"><img width="700" height="456" src="../image/bg5.jpg" alt="多彩腕表推荐"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="多彩腕表推荐" target="_blank">多彩腕表推荐<br>
                                        扮靓夏日玩味腕间色彩</a></h3>
                        ...
                        <li>
                            <dl>
                                <dt>
                                    <a href="detailPage.html" title="是不会穿还是没穿对" target="_blank"><img width="700" height="456" src="../image/bg6.jpg" alt="是不会穿还是没穿对"></a>
                                </dt>
                                <dd>
                                    <h3><a href="detailPage.html" title="是不会穿还是没穿对" target="_blank">是不会穿还是没穿对<br>
                                        时尚型男挑选西服的秘密</a></h3>
        ...
        <div class="hot-point wrap" id="hot-point">
            ...
            <div class="hot-point-content point0">
                <a href="">女装上新 </a>
                <a href="">粽情端午 <i class="gif-hot"></i> </a>
                <a href="">潮包抢新 </a>
                <a href="">抢购小米 </a>
                <a href="">指纹神机 </a>
                <a href="">毕业旅行 <i class="gif-new"></i></a>
            </div>
            <div class="hot-point-title">
                <h4>精彩推荐</h4>
                <div class="arrow"><em></em><span></span></div>
        ...
        <div id="banner" class="wrap">
            <a href=""><img src="../image/banner1.jpg" height="125" width="381" alt=""></a>
            <a href=""><img style="margin:0 -3px 0 -3px" src="../image/banner2.jpg" height="125" width="381" alt=""></a>
            <a href=""><img src="../image/banner3.jpg" height="125" width="381" alt=""></a>
        </div>
        <!-- 商品内容列表区域 -->
        <div id="content" class="wrap clear">
            <div class="getLove">
                    ...
                    <div class="shopListLeft">
                        ...
                        <div class="shopListRight">
                            <div class="shopListRightTop clear">
                                <a class="borderNone" href=""><img src="../image/book7.jpg" alt=""></a>
                ...
                <div id="banner" class="wrap">
                    <a href=""><img src="../image/banner5.jpg" height="125" width="381" alt=""></a>
                    <a href=""><img style="margin:0 -3px 0 -3px" src="../image/banner6.jpg" height="125" width="381" alt=""></a>
                    <a href=""><img src="../image/banner7.png" height="125" width="381" alt=""></a>
                </div>
                <div class="getLove">
                    <div class="getLoveTop tip1">
                        <h4>前端科技</h4>
