    ...
    <div id="container" style="width: auto;">
        <div id="cart">
            <div class="countdown_time_wrap">
                <span class="click_icon"></span> <strong>请在 <span class="cart_countdown_time">04分38秒</span> 内提交交易，并在下单后<span>30</span>分钟内完成支付。</strong>
            ...
            <form action="http://cart.jumei.com/cart/pay?from=new" method="post" id="check_pay_form" onsubmit="return false;" autocomplete="off" style="display:inline-block;">
                        ...
                        <div class="sp_icon_pos_tips">
                            ...
                            <div class="arrow_up"></div>
                                ...
                                <div class="clearfix cow_box">
                                    ...
                                    <div class="fl clearfix">
                                        <div class="fl site_menu_box JS_site_menu_box">
                                            <div>
                                                <a href="javascript:;" data-name="province" parentcode="0" change="false" class="site_menu clearfix JS_site_menu">
                                        ...
                                        <div class="fl site_menu_box disabled JS_site_menu_box">
                                            <div>
                                                <a href="javascript:;" data-name="city" class="site_menu clearfix JS_site_menu">
                                        ...
                                        <div class="fl site_menu_box disabled JS_site_menu_box">
                                            <div>
                                                <a href="javascript:;" data-name="county" class="site_menu clearfix JS_site_menu">
                                ...
                                <div class="clearfix cow_box">
                                    ...
                                    <div class="fl">
                                        <input type="text" placeholder="区号" class="input" id="JS_phone_area_new" maxlength="4" style="width: 50px;">
                                    </div>
                                    <div class="fl" style="margin: 0 5px;">-</div>
                                    <div class="fl">
                                        <input type="text" class="input" placeholder="电话号码" id="JS_phone_number_new" maxlength="8" style="width: 90px;">
                                    </div>
                                    <div class="fl" style="margin: 0 5px;">-</div>
                                    <div class="fl">
                                        <input type="text" class="input" placeholder="分机" id="JS_phone_ext_new" maxlength="8" style="width: 50px;">
                                    </div>
                ...
                <div class="cart_left relative" style="*z-index: 5;">
                    <div class="option cart_products">
                                    ...
                                    <tr id="702001016_ht150602p933681t2" class="cart_item" deal_hash_id="ht150602p933681t2">
                                        <td class="name text_left padd_left">
                                            <div style="width:320px;position: relative;line-height: 21px">
                                                <a href="http://www.jumeiglobal.com/deal/ht150602p933681t2.html?from=jmglobal" target="_blank" class="name_hover">
                                        Guerisson奇迹马油霜                                            <span class="item_note">容量：70g</span>
                                    </a>
                                                <div class="pic_hover">
                                                    <img src="http://p1.jmstatic.com/product/000/933/933681_std/933681_100_100.jpg" alt="Guerisson奇迹马油霜">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="number_box">
                                        ...
                                        <td colspan="4" class="count" style="padding:10px 0 10px 30px;">
                                            <div class="content">
                                                <div class="option_box express_wrap">
                                                    <span class="express_num" id="final_delivery_fee_redunction_notice_retail_global/0/" delivery_reduce="5">-¥<b class="J_Delivery_reduction">5</b></span>
                                    ...
                                    <tr class="order_amount">
                                        <td colspan="4" style="padding:0;">
                                            <div class="order_amount_container">
                                                ...
                                                <div class="use_promo_card" id="use_promo_card_show" style="float: left;margin-left: 20px;">可用现金券<span class="pink">5</span>张（最高减<span class="pink">70.00元</span>）</div>
                                                    ...
                                                    <div class="hongbao_box" style="*z-index: 10">
                                                        <div>
                                                            <div class="tr_promo_card" style="display:none;">
                                                                <span id="promo_card_reduction_notice_retail_global/0/" class="express_num">- ¥<span class="exp_num promo_card_amount">10</span></span>
                                                                <span class="express_tit">现金券抵扣：</span>
                                                            </div>
                                                            <span class="promo_card_text">使用现金券：</span>
                                                            <a href="#" class="choose_promo_card">请选择您的现金券</a><span class="or">或</span><span class="pink direct_input">直接输入券号</span>
                                                            <input type="text" size="25" maxlength="25" class="input_promo_card" value="输入现金券号">
                                                        ...
                                                        <div class="choose_promo_card_box" style="visibility: visible; display: none;">
                                                            <ul style="height: 224px;">
                                                                <li>
                                                                    <span>
                                                            <span class="pink">70</span>元现金券 (限除母婴和虚拟物品外全场通用商品满500元使用)
                                                                    </span>
                                                                    <span class="promo_card_num" style="display:none;">DSTJ2YYVEM3PVS</span>
                                                                    <br>
                                                                    <span class="con_gray">2015年06月07日到期</span>
                                                                    <span class="pink">即将到期</span>
                                                                </li>
                                                                <li>
                                                                    <span>
                                                            <span class="pink">40</span>元现金券 (限除母婴和虚拟物品外全场通用商品满300元使用)
                                                                    </span>
                                                                    <span class="promo_card_num" style="display:none;">DSLYZGXRJ5U2TK</span>
                                                                    <br>
                                                                    <span class="con_gray">2015年06月07日到期</span>
                                                                    <span class="pink">即将到期</span>
                                                                </li>
                                                                <li>
                                                                    <span>
                                                            <span class="pink">20</span>元现金券 (限全场通用(含极速免税店)商品满200元使用)
                                                                    </span>
                                                                    <span class="promo_card_num" style="display:none;">DSFVGEEG7KNXU9</span>
                                                                    <br>
                                                                    <span class="con_gray">2015年06月07日到期</span>
                                                                    <span class="pink">即将到期</span>
                                                                </li>
                                                                <li>
                                                                    <span>
                                                            <span class="pink">10</span>元现金券 (限全场通用(含极速免税店)商品满100元使用)
                                                                    </span>
                                                                    <span class="promo_card_num" style="display:none;">DS6XR7GWNMGTMF</span>
                                                                    <br>
                                                                    <span class="con_gray">2015年06月07日到期</span>
                                                                    <span class="pink">即将到期</span>
                                                                </li>
                                                                <li>
                                                                    <span>
                                                            <span class="pink">5</span>元现金券 (限自营商品使用)
                                                                    </span>
                                                                    <span class="promo_card_num" style="display:none;">SDWGG44X8NR6QF</span>
                                                                    <br>
                                                                    <span class="con_gray">2015年06月07日到期</span>
                                                                    <span class="pink">即将到期</span>
                                                                </li>
                                                    ...
                                                    <div class="hongbao_box" style="*z-index: 5">
                                                        <div>
                                                            <div class="tr_red_card" style="display:none;">
                                                                <span id="promo_red_reduction_notice_retail_global/0/" class="express_num">- ¥<span class="exp_num promo_red_amount"></span></span>
                                                                <span class="express_tit">红包抵扣</span>
                                                            </div>
                                                            <span class="promo_red_text">使用红包：</span>
                                                            <a href="#" class="choose_red_card">请选择您的红包</a><span class="or">或</span><span class="pink direct_input">直接输入券号</span>
                                                            <input type="text" size="25" maxlength="25" class="input_red_card" value="输入红包号">
                                                ...
                                                <div class="price_count express_num">
                                                    <div class="price">
                                                        ¥<span id="total_amount_retail_global/0/" class="total_amount">
                                                                                    99.00                                                                            </span>
                                                    </div>
                                                </div>
                        ...
                        <div class="inv_wrap">
                            <input type="checkbox" id="is_need_invoice" class="is_need_inv" name="is_need_invoice" value="1" disabled="">
                    ...
                    <a href="http://www.jumei.com/help/fapiao" target="_blank">更多信息</a>
                        ...
                        <div class="inv_info" style="display: block;">
                            <div class="inv_edit_wrap" style="display: none;">
                                ...
                                <input type="text" class="inv_type_name focus_txt" name="invoice_companyname" maxlength="200" value="" disabled="" focustxt="请输入单位名称">&nbsp;&nbsp;<span class="inv_error" style="display: none;">请输入正确的单位名称</span>
                                <br>
                            </div>
                            <div class="clearfix" style="_position: relative;">
                                ...
                                <div class="fl">
                                    ...
                                    <div class="inv_pro_list">
                                        <ul>
                                                                                <li>
                                                <div class="inv_pro_img"><img src="http://p1.jmstatic.com/product/000/933/933681_std/933681_100_100.jpg"></div>
                ...
                <div class="paytype">
                    <div id="paytype_gateway" class="paytype_gateway_after">
                        <div id="gateway_list" class="gateway_list" style="_height: 1%">
                            ...
                            支付宝扫码支付抽奖送红包，最高500元！
                            <div style="left: -220px;height: auto;top: -222px;width: 600px;">
                                ...
                                6、本活动仅限实名认证用户参与，同一用户 （同一支付宝账号、身份证号、终端设备等均视为同一用户条件）限参与一次；<br>
                                ...
                                <span style="top: 206px;"></span>
                                        ...
                                        <ul class="third_ul clearfix g_ul">
                                            ...
                                            <li>
                                                <div class="bd_wrap">
                                                    <input type="radio" value="AlipayQRCode" name="gateway" id="check-Alipay-QRCode">
                                                    <label class="bg AlipayQRCode" for="check-Alipay-QRCode"></label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="bd_wrap">
                                    ...
                                    <li class="gateway_line ul_off">
                                        ...
                                        <label class="tit gateway_desc" for=""><span>支持地方银行，需开通网银支付功能</span></label>
                                        <ul class="bank_ul clearfix g_ul">
                                            ...
                                            <li>
                                                <div class="bd_wrap">
                                                    <input type="radio" value="Alipay_CITIC" name="gateway" id="check-Alipay_CITIC">
                                    ...
                                    <li class="gateway_line ul_off">
                                        ...
                                        <label class="tit gateway_desc" for=""><span>支持信用卡付款，无需开通网银支付功能</span></label>
            ...
            <div class="confirm_pay_box">
                <div class="confirm_pay clearfix">
                    <div class="confirm_left">
                        <a href="http://cart.jumei.com/i/cart/show/?from=confirmation_modify_cart_new" class="btn_grey_small">返回修改购物车</a>
                    </div>
