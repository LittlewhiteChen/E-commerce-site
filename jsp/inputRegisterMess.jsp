...
<body>
    ...
    <div class="registerMian">
        <form  action="success.jsp" method="post" id="register_form" name="form">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="z_index2">
                                        ...
                                        <ul style="display: none;" id="select_emaildomain" class="email_select">
                                            <li domin="" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@qq.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@163.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@126.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@sina.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@hotmail.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@sohu.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@gmail.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@tom.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@139.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@21cn.com" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@yeah.net" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                            <li domin="@sina.cn" title="" onmouseover="this.className=&quot;hover_domain&quot;" onmouseout="this.className=&quot;&quot;"></li>
                                        </ul>
                                        <span class="icon_yes" style="display: none;" id="spn_username_ok"></span><span class="warn" style="display: none;" id="spn_username_wrong"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="t">
                                ...
                                <tr style="display: " id="tb_tr_reg_vcode">
                                    ...
                                    <td>
                                        ...
                                        <div class="v_box" style="display:none">
                                            <a tabindex="5" name="change_code_img" href="javascript:show_vcode('imgVcode')">
                                                <img width="238" height="68" class="v" alt="点击更换验证码" title="点击更换验证码" id="imgVcode" src="p/tmp_proxy.php?t=1429334247356"></a>看不清?<a tabindex="6" name="change_code_link" href="javascript:show_vcode('imgVcode')">换张图</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="in_repassword">
                                        <input type="text" tabindex="3" style="display:'';" onpaste="return false" onkeydown="CheckdoSubmit(event)" onkeyup="repassword_session_check()" onblur="repassword_check()" onfocus="check_repassword_focus()" class="text" name="realname" id="realname">
                                        <input type="text" tabindex="3" style="display:none" onpaste="return false" onkeydown="CheckdoSubmit(event)" onkeyup="repassword_session_check()" onblur="repassword_check()" onfocus="check_repassword_focus()" class="text" name="hid_txt_repassword" id="hid_txt_repassword">
                                        <span style="display: none;" class="warn" id="spn_repassword_ok"></span><span class="cue" style="display: none;" id="spn_repassword_wrong"></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="in_repassword">
                                        <input type="text" tabindex="3" onpaste="return false" onkeydown="CheckdoSubmit(event)" onkeyup="repassword_session_check()" onblur="repassword_check()" onfocus="check_repassword_focus()" class="text" name="phone" id="txt_repassword">
                                        <input type="text" tabindex="3" style="display:none" onpaste="return false" onkeydown="CheckdoSubmit(event)" onkeyup="repassword_session_check()" onblur="repassword_check()" onfocus="check_repassword_focus()" class="text" name="hid_txt_repassword" id="hid_txt_repassword">
                                        <span style="display: none;" class="warn" id="spn_repassword_ok"></span><span class="cue" style="display: none;" id="spn_repassword_wrong"></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="submit" tabindex="7" onclick="check_register();" value="立刻注册" title="注册" class="btn_login" name="g" id="btn_register">
                                ...
                                <tr>
                                    ...
                                    <td class="clause">
                                        <span class="float_l">
                                        <input type="checkbox" tabindex="8" onclick="agreeement_check()" onmouseover="this.style.cursor='pointer';this.style.cursor='hand';" checked="checked" name="chb_agreement" id="chb_agreement">我已阅读并同意<a tabindex="9" target="_blank" href=" http://help.dangdang.com/details/page12">《时代交易条款》</a>和<a tabindex="10" target="_blank" href="http://help.dangdang.com/details/page42">《时代社区条款》</a></span>
            ...
            <div style="display:none" class="register_pop" id="div_identity_verification">
                ...
                <div class="body">
                    <dl>
                        <p style="margin-left: 20px;color:red; height: 50px;" id="temp_mind">由于近期运营商调整了短信发送规则,可能造成信息发送延迟.如果您长时间未收到验证短信,请尝试重新发送</p>
                        <dt>手机号码：</dt>
                        <dd>
                            <b id="b_pop_mobliephone"></b><span class="btn_time" id="jishi">24秒后重新获取</span><a style="display: none;" class="btn_go_buy" id="ajishi" href="#">重新获取验证码</a>
                        ...
                        <dt>验证码：</dt>
                        <dd>
                            <input type="text" maxlength="6" onblur="pop_sms_vcode_check()" onfocus="check_pop_sms_vcode_focus()" onkeydown="CheckdoPopSubmit(event)" value="" class="text" autocomplete="off" name="txt_pop_sms_vcode" id="txt_pop_sms_vcode"><span style="display: none" id="spn_pop_sms_vcode_ok"></span>
                        ...
                        <dd style="display: none;" id="dd_mp_vcode">
                            <input type="text" maxlength="4" onkeydown="CheckdoPopSubmit(event)" onblur="pop_vcode_check()" onfocus="check_pop_vcode_focus()" autocomplete="off" value="" class="text" name="txt_pop_vcode" id="txt_pop_vcode"><span style="display: none;" class="" id="spn_pop_vcode_ok"></span>
    ...
    <div id="footer" class="padb10">
        ...
        <p class="padt5 textc cor2 lh20">版权所有&nbsp;&copy;&nbsp;武汉科技大学&nbsp;&nbsp;地址:洪山区黄家湖3号&nbsp;&nbsp;邮编:430063&nbsp;&nbsp;鄂ICP备&nbsp;05064445号&nbsp;鄂公网安备110402430070
        </p>
    </div>
    <script src="../js/jquey-1.8.0.min.js" type="text/javascript"></script>
